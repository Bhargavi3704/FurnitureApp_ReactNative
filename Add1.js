  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageWrapper}>
        <Image
          source={require("../Images/Chair.png")} // Replace with actual image URL
          style={styles.image}
        />
      </View>
      <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate("Add2")}>
        <Icon name="chevron-right-circle" size={35} color="white" />
      </TouchableOpacity>
    </View>
  );
};
